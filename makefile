...
TEST    = trim_str_test_app
PROGRAM = trim_str_app

COMMON_HDRS      = general.h 
LIBRARY_FILES    = shortcut
ASSIGNMENT_HDRS  = 
ASSIGNMENT_FILES = trim
TEST_FILES       = test_trim
MAIN_DRIVER      = trim_str
TEST_DRIVER      = trim_str_test_driver
